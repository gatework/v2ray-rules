# 简介 ![GitHub Downloads (all assets, all releases)](https://img.shields.io/github/downloads/gatework/v2ray-rules/total?logo=github) ![GitHub Downloads (all assets, latest release)](https://img.shields.io/github/downloads/gatework/v2ray-rules/latest/total?logo=github) [![jsdelivr stats](https://data.jsdelivr.com/v1/package/gh/gatework/v2ray-rules/badge?style=rounded)](https://www.jsdelivr.com/package/gh/gatework/v2ray-rules)
...
- **加入大量中国大陆域名、Apple 域名和 Google 域名**：
  ...
  - [@felixonmars/dnsmasq-china-list/apple.china.conf](https://github.com/felixonmars/dnsmasq-china-list/blob/master/apple.china.conf) 加入到 `geosite:geolocation-!cn` 类别中（如希望本文件中的 Apple 域名直连，请参考下面 [geosite 的 Routing 配置方式](https://github.com/gatework/v2ray-rules#geositedat-1)）
  - [@felixonmars/dnsmasq-china-list/google.china.conf](https://github.com/felixonmars/dnsmasq-china-list/blob/master/google.china.conf) 加入到 `geosite:geolocation-!cn` 类别中（如希望本文件中的 Google 域名直连，请参考下面 [geosite 的 Routing 配置方式](https://github.com/gatework/v2ray-rules#geositedat-1)）
- **加入 GFWList 域名**：
...
- **加入 Windows 操作系统相关的系统升级和隐私跟踪域名**：
  ...
  - 关于这三个类别的使用方式，请参考下面 [geosite 的 Routing 配置方式](https://github.com/gatework/v2ray-rules#geositedat-1)
- **可添加自定义直连、代理和广告域名**：由于上游域名列表更新缓慢或缺失某些域名，所以引入**需要添加的域名**列表。[`hidden 分支`](https://github.com/gatework/v2ray-rules/tree/hidden)里的三个文件 `direct.txt`、`proxy.txt` 和 `reject.txt`，分别存放自定义的需要添加的直连、代理、广告域名，最终分别加入到 `geosite:cn`、`geosite:geolocation-!cn` 和 `geosite:category-ads-all` 类别中
- **可移除自定义直连、代理和广告域名**：由于上游域名列表存在需要被移除的域名，所以引入**需要移除的域名**列表。[`hidden 分支`](https://github.com/gatework/v2ray-rules/tree/hidden)里的三个文件 `direct-need-to-remove.txt`、`proxy-need-to-remove.txt` 和 `reject-need-to-remove.txt`，分别存放自定义的需要从 `direct-list`（直连域名列表）、`proxy-list`（代理域名列表）和 `reject-list`（广告域名列表） 移除的域名
...
- **geoip.dat**：
  - [https://github.com/gatework/v2ray-rules/releases/latest/download/geoip.dat](https://github.com/gatework/v2ray-rules/releases/latest/download/geoip.dat)
  - [https://cdn.jsdelivr.net/gh/gatework/v2ray-rules@release/geoip.dat](https://cdn.jsdelivr.net/gh/gatework/v2ray-rules@release/geoip.dat)
- **geosite.dat**：
  - [https://github.com/gatework/v2ray-rules/releases/latest/download/geosite.dat](https://github.com/gatework/v2ray-rules/releases/latest/download/geosite.dat)
  - [https://cdn.jsdelivr.net/gh/gatework/v2ray-rules@release/geosite.dat](https://cdn.jsdelivr.net/gh/gatework/v2ray-rules@release/geosite.dat)
- **直连域名列表 direct-list.txt**：
  - [https://raw.githubusercontent.com/gatework/v2ray-rules/release/direct-list.txt](https://raw.githubusercontent.com/gatework/v2ray-rules/release/direct-list.txt)
  - [https://cdn.jsdelivr.net/gh/gatework/v2ray-rules@release/direct-list.txt](https://cdn.jsdelivr.net/gh/gatework/v2ray-rules@release/direct-list.txt)
- **代理域名列表 proxy-list.txt**：
  - [https://raw.githubusercontent.com/gatework/v2ray-rules/release/proxy-list.txt](https://raw.githubusercontent.com/gatework/v2ray-rules/release/proxy-list.txt)
  - [https://cdn.jsdelivr.net/gh/gatework/v2ray-rules@release/proxy-list.txt](https://cdn.jsdelivr.net/gh/gatework/v2ray-rules@release/proxy-list.txt)
- **广告域名列表 reject-list.txt**：
  - [https://raw.githubusercontent.com/gatework/v2ray-rules/release/reject-list.txt](https://raw.githubusercontent.com/gatework/v2ray-rules/release/reject-list.txt)
  - [https://cdn.jsdelivr.net/gh/gatework/v2ray-rules@release/reject-list.txt](https://cdn.jsdelivr.net/gh/gatework/v2ray-rules@release/reject-list.txt)
- **@felixonmars/dnsmasq-china-list 仓库收集的在中国大陆可直连的域名列表 china-list.txt**：
  - [https://raw.githubusercontent.com/gatework/v2ray-rules/release/china-list.txt](https://raw.githubusercontent.com/gatework/v2ray-rules/release/china-list.txt)
  - [https://cdn.jsdelivr.net/gh/gatework/v2ray-rules@release/china-list.txt](https://cdn.jsdelivr.net/gh/gatework/v2ray-rules@release/china-list.txt)
- **Apple 在中国大陆可直连的域名列表 apple-cn.txt**：
  - [https://raw.githubusercontent.com/gatework/v2ray-rules/release/apple-cn.txt](https://raw.githubusercontent.com/gatework/v2ray-rules/release/apple-cn.txt)
  - [https://cdn.jsdelivr.net/gh/gatework/v2ray-rules@release/apple-cn.txt](https://cdn.jsdelivr.net/gh/gatework/v2ray-rules@release/apple-cn.txt)
- **Google 在中国大陆可直连的域名列表 google-cn.txt**：
  - [https://raw.githubusercontent.com/gatework/v2ray-rules/release/google-cn.txt](https://raw.githubusercontent.com/gatework/v2ray-rules/release/google-cn.txt)
  - [https://cdn.jsdelivr.net/gh/gatework/v2ray-rules@release/google-cn.txt](https://cdn.jsdelivr.net/gh/gatework/v2ray-rules@release/google-cn.txt)
- **GFWList 域名列表 gfw.txt**：
  - [https://raw.githubusercontent.com/gatework/v2ray-rules/release/gfw.txt](https://raw.githubusercontent.com/gatework/v2ray-rules/release/gfw.txt)
  - [https://cdn.jsdelivr.net/gh/gatework/v2ray-rules@release/gfw.txt](https://cdn.jsdelivr.net/gh/gatework/v2ray-rules@release/gfw.txt)
- **Windows 操作系统使用的隐私跟踪域名列表 win-spy.txt**：
  - [https://raw.githubusercontent.com/gatework/v2ray-rules/release/win-spy.txt](https://raw.githubusercontent.com/gatework/v2ray-rules/release/win-spy.txt)
  - [https://cdn.jsdelivr.net/gh/gatework/v2ray-rules@release/win-spy.txt](https://cdn.jsdelivr.net/gh/gatework/v2ray-rules@release/win-spy.txt)
- **Windows 操作系统使用的系统升级域名列表 win-update.txt**：
  - [https://raw.githubusercontent.com/gatework/v2ray-rules/release/win-update.txt](https://raw.githubusercontent.com/gatework/v2ray-rules/release/win-update.txt)
  - [https://cdn.jsdelivr.net/gh/gatework/v2ray-rules@release/win-update.txt](https://cdn.jsdelivr.net/gh/gatework/v2ray-rules@release/win-update.txt)
- **Windows 操作系统使用的附加隐私跟踪域名列表 win-extra.txt**：
  - [https://raw.githubusercontent.com/gatework/v2ray-rules/release/win-extra.txt](https://raw.githubusercontent.com/gatework/v2ray-rules/release/win-extra.txt)
  - [https://cdn.jsdelivr.net/gh/gatework/v2ray-rules@release/win-extra.txt](https://cdn.jsdelivr.net/gh/gatework/v2ray-rules@release/win-extra.txt)
...
geodata-mode: true
geox-url:
  geoip: "https://cdn.jsdelivr.net/gh/gatework/v2ray-rules@release/geoip.dat"
```
</details>
...
[![Stargazers over time](https://starchart.cc/gatework/v2ray-rules.svg)](https://starchart.cc/gatework/v2ray-rules)
